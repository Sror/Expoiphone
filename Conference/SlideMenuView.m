...
-(id) initWithFrameColorAndButtons:(CGRect)frame backgroundColor:(UIColor*)bgColor  buttons:(NSMutableArray*)buttonArray  {
	...
	if (self = [super initWithFrame:frame]) {
        ...
        NSLog(@"menu scroll frame is %f,%f",frame.origin.x,frame.origin.y);
		...
		[menuScrollView setContentSize:CGSizeMake(totalButtonWidth, menuScrollView.frame.size.height)];
